...
$(document).ready(function () {
	...
	$('.confirm-featured').on('click', function (e) {
		...
		swal({
			title: "Are you sure?",
			text: "You Product Will be Featured ",
			icon: "warning",
			showCancelButton: true,
			buttons: {
				cancel: {
	...
	$('.remove-featured').on('click', function (e) {
		...
		swal({
			title: "Are you sure?",
			text: "You Product Will be Unfeatured",
			icon: "warning",
			showCancelButton: true,
			buttons: {
				cancel: {
	...
	$('.make-out-stock').on('click', function (e) {
		...
		swal({
			title: "Are you sure?",
			text: "You Product Wont Show on The Website",
			icon: "warning",
			showCancelButton: true,
			buttons: {
				cancel: {
	...
	$('.stock-in').on('click', function (e) {
		...
		swal({
			title: "Are you sure?",
			text: "You Product Will Show on The Website",
			icon: "warning",
			showCancelButton: true,
			buttons: {
				cancel: {
	...
	$('.cancel-order').on('click', function () {
		swal({
			...
			if (isConfirm) {
				...
				swal("Not Cancelled!", "Your Order Not Cancelled :)", "error");
			}
		});
	});
