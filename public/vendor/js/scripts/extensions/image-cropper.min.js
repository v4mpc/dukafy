$(document).ready(function () {
    var o = $(".main-demo-image"),
        e = ($(".download"), $(".main-demo-dataX")),
        r = $(".main-demo-dataY"),
        a = $(".main-demo-dataHeight"),
        t = $(".main-demo-dataWidth"),
        i = $(".main-demo-dataRotate"),
        c = $(".main-demo-dataScaleX"),
        n = $(".main-demo-dataScaleY"),
        p = {
            viewMode: 1,
            ...
            preview: ".img-preview",
            crop: function (o) {
                e.val(Math.round(o.x)), r.val(Math.round(o.y)), a.val(Math.round(o.height)), t.val(Math.round(o.width)), i.val(o.rotate), c.val(o.scaleX), n.val(o.scaleY)
            }
        };
    o.cropper(p), $(".get-data-btn").on("click", function () {
        result = o.cropper("getData"), $(".get-data").val(JSON.stringify(result))
    }), $(".get-image-data-btn").on("click", function () {
        result = o.cropper("getImageData"), $(".get-image-data").val(JSON.stringify(result))
    }), $(".get-container-data-btn").on("click", function () {
        result = o.cropper("getContainerData"), $(".get-container-data").val(JSON.stringify(result))
    }), $(".get-canvas-data-btn").on("click", function () {
        result = o.cropper("getCanvasData"), $(".get-canvas-data").val(JSON.stringify(result))
    }), $(".get-cropbox-data-btn").on("click", function () {
        result = o.cropper("getCropBoxData"), $(".get-cropbox-data").val(JSON.stringify(result))
        ...
        o.cropper("rotate", 180)
    }), $(".flip-horizontal").on("click", function () {
        var e = $(this).data("option");
        o.cropper("scaleX", -e), $(this).data("option", -e)
    }), $(".flip-vertical").on("click", function () {
        var e = $(this).data("option");
        o.cropper("scaleY", -e), $(this).data("option", -e)
