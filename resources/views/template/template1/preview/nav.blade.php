<nav class="navbar ownmenu">
  <div class="container">
    ...
    <div class="nav-right">
      <ul>
        @if($previews->facebook!=null)
        <li><a href="{{$previews->facebook}}"><i  class="fa fa-facebook white-fonts"></i></a></li>
        @endif @if($previews->instagram!=null)
        <li><a href="{{$previews->instagram}}"><i  class="fa fa-instagram white-fonts"></i></a></li>
        @endif @if($previews->twitter!=null)
        <li><a href="{{$previews->twitter}}"><i  class="fa fa-twitter white-fonts"></i></a></li>
        @endif
