      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="item-col-4">
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-1.jpg')}}" alt=""> <span class="sale-tag">-25%</span>
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-2.jpg')}}" alt="">
                <!-- Content -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-3.jpg')}}" alt="">
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-4.jpg')}}" alt="">
                <!-- Content -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-5.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-6.jpg')}}" alt="">
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-7.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{('template1/images/item-img-1-8.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-9.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-11.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-12.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-13.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-15.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-16.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 </a>
                <!-- Reviews -->
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-17.jpg')}}" alt="">
            ...
            <!-- Product -->
            <div class="product">
              <article> <img class="img-responsive" src="{{asset('template1/images/item-img-1-18.jpg')}}" alt="">
                <!-- Content -->
                <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a>
                <!-- Reviews -->
