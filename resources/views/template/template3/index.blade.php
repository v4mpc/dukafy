            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <div class="product-info text-left">
                            <h5 class="hidden-xs hidden-sm"><a href="{{route('product.show',$product->id)}}" title="{{$product->name}}">{{strlen($product->name)>35?str_limit($product->name,35):$product->name}}</a></h5>
