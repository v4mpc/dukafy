<header id="masthead" class="site-header header-v1">
    ...
    <div class="header-logo">
        <a href="{{route('start')}}" class="header-logo-link">
    ...
    <!-- ============================================================= Header Logo : End============================================================= -->
        ...
        <div class="input-group">
            <input type="text" id="search" class="form-control search-field" name="query" value="{{request()->input('query')}}" dir="ltr" value="" name="s" placeholder="Search for products" />
            <div class="input-group-addon search-categories">
                <select name="category_name" id='product_cat' class='postform resizeselect' >
            ...
            <div class="input-group-btn">
                <input type="hidden" id="search-param" name="querdy" value="{{request()->input('query')}}" />
    ...
    <ul class="navbar-wishlist nav navbar-nav pull-right flip">
        ...
        <li class="nav-item">
            <a href="{{$settings->facebook}}" class="nav-link"><i class="fa fa-facebook"></i></i></a>
        </li>
        @endif @if($settings->instagram!=null)
        <li class="nav-item">
            <a href="{{$settings->instagram}}" class="nav-link"><i class="fa fa-instagram"></i></i></a>
        </li>
        @endif @if($settings->twitter!=null)
        <li class="nav-item">
            <a href="{{$settings->twitter}}" class="nav-link"><i class="fa fa-twitter"></i></i></a>
        </li>
        @endif
