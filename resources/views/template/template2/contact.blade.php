                                ...
                                <form class="wpcf7-form" method="post" action="#">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <span class="wpcf7-form-control-wrap last-name"><input type="email" aria-invalid="false" aria-required="true" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required input-text" size="40" value="" name="email"></span>
                                        </div>
                                    </div>
