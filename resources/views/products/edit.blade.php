                  ...
                  <form class="form form-horizontal" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-7">
                          <input type="text" id="projectinput1" class="form-control" value="{{$product->name or old('name')}}" placeholder="Name" name="name">
                          </div>
                        </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-7">
                                  <fieldset>
                                      ...
                                      <input type="text" name="price" class="form-control" value="{{$product->price or old('price')}}" placeholder="Enter Price then Toggle Show Price" aria-describedby="radio-addon4">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                <textarea id="userinput8" rows="6" class="form-control" name="description" placeholder="Describe your product...">{{$product->description or old('description')}}</textarea>
                                </div>
                              </div>
                        ...
                        <div id="variation_fields">
                         ...
                         <div class="form-group row">
                           <div class="col-sm-3 nopadding">
                               <div class="form-group">
                               <input type="text" class="form-control" id="Degree" name="variation[]" value="{{$variation->variation}}" placeholder="Title">
                               </div>
                             </div>
                             <div class="col-sm-3 nopadding">
                               <div class="form-group">
                             ...
                             <div class="col-sm-3 nopadding">
                                 <div class="form-group">
                                 <input type="text" class="form-control" id="Degree" name="variation_value[]" value="{{$variation->value}}" placeholder="Description">
                                 </div>
                               </div>
                               <div class="col-sm-3 nopadding">
                                 <div class="form-group">
                                   <div class="input-group">
                                       <fieldset>
                                           <div class="input-group">
                                           <input type="text" class="form-control" name="variation_price[]" value="{{$variation->price}}" placeholder="Price" aria-describedby="button-addon2">
                                             <div class="input-group-append">
                                               <button type="button" class="btn btn-success" id="add_field" > <i class="ft-plus"></i></button>
                                             </div>
                                           </div>
