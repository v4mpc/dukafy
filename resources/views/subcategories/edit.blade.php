...
<div class="app-content content">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Edit Sub-Category</h3>
    ...
    <form action="{{route('sub_categories.update',$sub_category->id)}}" method="POST" class="form form-horizontal" >
      ...
      <div class="form-body">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-9">
                ...
                <option value="{{$category->id}}" {{($category->id==$sub_category->category_id)?"selected=selected":""}} >{{$category->name}}</option>
                 @endforeach
                </select>
              </div>
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" id="projectinput1" class="form-control" placeholder="Name" name="name" value="{{$sub_category->name}}">
            </div>
          </div>
