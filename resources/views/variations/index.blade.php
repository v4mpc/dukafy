        ...
        <div class="content-wrapper">
          <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
              <h3 class="content-header-title mb-0 d-inline-block">All Variations</h3>
              <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index-2.html">Home</a>
                    </li>
                    <li class="breadcrumb-item"><a href="#">Variations</a>
                    </li>
            ...
            <div class="content-header-right col-md-6 col-12">
              ...
              <button data-toggle="modal" data-target="#inlineForm" class="btn btn-float btn-round btn-primary">Add Variation</button>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <label class="modal-title text-text-bold-600" id="myModalLabel33">Enter Variation Name</label>
                  ...
                  {{csrf_field()}}
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <input type="text" placeholder="variation name" class="form-control" name="name">
                      </div>
                          ...
                          <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                              ...
                              <td>{{$variation->name}}</td>
                                  <td>
<ul>
  @foreach($variation->subVariations as $sub_variation)
<li>{{$sub_variation->name}}</li>
@endforeach
                                ...
                                <td>
                                <a href="{{route('variations.edit', $variation->id)}}" data-toggle="tooltip" data-original-title="Edit" data-placement="top"  class="btn btn-outline-success edit-item-btn"><i class="ft-edit"></i></a>
                                <a data-toggle="tooltip" data-id="{{$variation->id}}"  data-original-title="Delete"  data-placement="top" data-url="/manage/variations/" data-name="Variation"  class="btn btn-outline-danger edit-item-btn confirm-color" ><i class="ft-trash"></i></a>
