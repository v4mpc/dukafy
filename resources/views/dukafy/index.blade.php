...
<script>
    ...
    fbq('init', '1733607240209893');
    fbq('track', 'PageView');
  </script>
  <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1733607240209893&ev=PageView&noscript=1"
  /></noscript>
...
<!-- Global site tag (gtag.js) - Google Ads: 1035425306 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1035425306"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-1035425306');
</script>
