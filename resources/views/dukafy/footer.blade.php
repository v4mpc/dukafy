...
<body>
    ...
    <div id="top" class="page-wrap header-bg">
            ...
            <div class="container">
                <div class="row header-row">
                    ...
                    <div class="col-12 col-md-6 align-self-center header-macbook">
                        <img class="jump" src="img/macbook.png" alt="macbook">
                    </div>
                    <!-- Phone end -->
                    <!-- Social icons -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 mb-30">
                        <div class="card-features">
                            <img src="img/layers.png" alt="icon">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 mb-30">
                        <div class="card-features">
                            <img src="img/running.png" alt="icon">
                    ...
                    <div class="col-12 col-sm-6 col-md-3 mb-30">
                        <div class="card-features">
                            <img src="img/pantone.png" alt="icon">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7 mb-30 pull-lg-7 align-self-center screens-1">
                        <img src="img/artboard-1.png" alt="screens">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7 mb-30 align-self-center screens-1">
                        <img src="img/artboard-2.png" alt="screens">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="contact" class="p-0-60">
            <div class="container">
                <div class="bg-map">
                    <img src="img/bg-map.png" alt="map">
                </div>
                <div class="row">
