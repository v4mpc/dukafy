                        ...
                        <div class="card">
                          ...
                          <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                              ...
                              <a data-toggle="tooltip" data-id="{{$product->id}}" data-original-title="Unfeature" data-placement="top"  class="btn btn-outline-warning remove-featured"><i class="ft-x-square"></i></a>
