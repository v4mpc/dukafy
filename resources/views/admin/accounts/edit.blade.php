            ...
            <div class="card">
              ...
              <div class="card-content collpase show">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <form class="form form-horizontal" action="{{route('accounts.update',$account->id)}}" method="POST">
                        ...
                        <div class="form-body">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-7">
                              <input type="text" id="name" class="form-control" value="{{$account->name or old('name')}}" placeholder="Name" name="name">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-7">
                              <div class="input-group">
                                <input type="text" class="form-control" placeholder="abc" aria-describedby="basic-addon2" name="sub_domain" value="{{$account->sub_domain or old('sub_domain')}}" disabled>
                                <div class="input-group-append">
                                  <span class="input-group-text" id="basic-addon2">.{{strtolower(env('APP_NAME'))}}.co.tz</span>
                                </div>
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-7">
                              <input type="email" class="form-control" value="{{$account->email or old('email')}}" placeholder="Email" name="email" disabled>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-7">
                                <input type="file" class="form-control"  placeholder="Email" name="logo">
                              </div>
                            </div>
