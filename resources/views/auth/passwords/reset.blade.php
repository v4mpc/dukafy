          ...
          <div class="col-md-4 col-10 box-shadow-2 p-0">
            ...
            @endif
              ...
              <div class="card-content">
                <div class="card-body">
                  <form class="form-horizontal form-simple" method="POST" action="{{ route('password.request') }}" novalidate>
                    {{ csrf_field() }}
                    <fieldset class="form-group position-relative has-icon-left mb-0">
                      <input type="email" class="form-control form-control-lg input-lg" id="user-name" name="email" value="{{ $email or old('email') }}" placeholder="Your Email" required>
                      @if ($errors->has('email'))
                  ...
                  @endif
                    ...
                    <br>
                    <fieldset class="form-group position-relative has-icon-left">
                      <input  class="form-control form-control-lg input-lg" type="password" id="user-password" name="password_confirmation" placeholder="Confirm Password"
                        required>
                      <div class="form-control-position">
                        <i class="ft-lock"></i>
                      </div>
                    ...
                    <button type="submit" class="btn btn-success btn-lg btn-block"><i class="ft-unlock"></i> Reset Password</button>
                  </form>
                </div>
              </div>
